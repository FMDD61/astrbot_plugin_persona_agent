...
`lineage` = `f"{kind}:{group_id}"`（如 `rp:100000001` / `gate:100000001`）。
"""
import json
import os
import sys
...
class TestLineage(unittest.TestCase):
    def test_lineage_format(self):
        self.assertEqual(lineage_of("rp", "100000001"), "rp:100000001")
        self.assertEqual(lineage_of("gate", "100000001"), "gate:100000001")
