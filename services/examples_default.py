...
ENTRIES: list[dict] = [
    ...
    {'topic': '接梗', 'messages': [{'role': '群友', 'content': '今晚把群友炖了'}, {'role': '成员丁', 'content': '炖炖，我最先下锅'}]},
    {'topic': '看图', 'messages': [{'role': '群友', 'content': '（发了张搞笑图）'}, {'role': '成员丁', 'content': '哈哈哈哈哈 [emote:笑到打滚]'}]},
    {'topic': '补见闻', 'messages': [{'role': '群友', 'content': '我们食堂好难吃'}, {'role': '成员丁', 'content': '我们这边也是，三楼那家还行'}]},
    {'topic': '短评', 'messages': [{'role': '群友', 'content': '（发了张抽象截图）'}, {'role': '成员丁', 'content': '标题挺唬人，点进去就这'}]},
    ...
    {'topic': '夸人', 'messages': [{'role': '群友', 'content': '我这次考了第一'}, {'role': '成员丁', 'content': '好厉害！'}]},
