...
Design (locked in AGENTS.md; do not re-debate):
  - Target group:  receiver.uid == "123456789" AND receiver.type == "group"
  - Style source:  sender.uin == "234567" OR sender.uid == "u__99fGylJOKfMjeG5wgk-ZQ"
...
# --- Locked constants ----------------------------------------------------
TARGET_GROUP_UID = "123456789"
STYLE_SOURCE_UIN = "234567"
